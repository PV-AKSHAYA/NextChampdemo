...
class UserDetails {
  ...
  static UserDetails decode(Object result) {
    ...
    return UserDetails(
      ...
      gender: result[1] as String?,
      mobile: result[2] as String?,
...
class UserApi {
  ...
  Future<UserDetails?> registerUser(UserDetails details) async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.nextchamp.UserApi.registerUser$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
    );
    final Future<Object?> pigeonVar_sendFuture = pigeonVar_channel.send(<Object?>[details]);
